...
png(filename="output/figure5.png", units = 'px', width=543*20, height=357*20,res=2000)
p<-ggplot(data=plot_dat[plot_dat$Network%in%c('MSNBC','FOX'),], aes(x=`Death Mention`, y=fit, fill=Network)) +
